...
OUTPUT_DIR = BASE_DIR / "outputs_roberta_mean_v6"
...
def train_with_validation(tokenizer, device):
    ...
    checkpoint_path = OUTPUT_DIR / "validation_best_roberta_mean_v6.pt"
    ...
    save_csv_checked(
        history_df,
        OUTPUT_DIR / "training_history_roberta_mean_v6.csv"
    )
    ...
    save_csv_checked(
        val_predictions_df,
        OUTPUT_DIR / "validation_predictions_roberta_mean_v6.csv"
    )
...
def train_full_model(seed, epochs, tokenizer, device):
    ...
    checkpoint_path = OUTPUT_DIR / f"full_model_roberta_mean_v6_seed{seed}.pt"
...
submission_path = OUTPUT_DIR / "submission_roberta_mean_v6.csv"
